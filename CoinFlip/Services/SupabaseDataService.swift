...
class SupabaseDataService: DataServiceProtocol {
    ...
    func createUser(_ user: User) async throws -> User {
        ...
        if let jsonString = String(data: userData, encoding: .utf8) {
            print("📤 Sending user data to Supabase (as array): \(jsonString)")
        }
        ...
        do {
            ...
            print("🔍 Fetching created user by username: \(user.username)")
            ...
            if let jsonString = String(data: fetchResponse.data, encoding: .utf8) {
                print("📥 Fetched user data: \(jsonString)")
            }
            ...
            print("✅ User created successfully: \(createdUser.username)")
            return createdUser
        } catch let error as NSError {
            ...
            print("❌ Supabase insert error (non-NSError): \(error)")
            throw error
        }
    }
    ...
    func createPortfolio(userId: UUID, startingBalance: Double) async throws -> Portfolio {
        ...
        print("✅ Portfolio HTTP Response: Status \(statusCode)")
